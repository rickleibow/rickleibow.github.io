...
projectOneSeeLiveSource.innerHTML = `
  ...
  <button class="see-source" type="button" onclick="window.open('https://github.com/rickleibow/stock-data'); return false;">
...
projectTwoSeeLiveSource.innerHTML = `
  <button class="see-live" type="button" onclick="window.open('https://rickleibow.github.io/Leaderboard/dist/index.html'); return false;">
    <p>See live</p><img src="images/ic_link.svg" alt="download-icon">
  </button>
  <button class="see-source" type="button" onclick="window.open('https://github.com/rickleibow/Leaderboard'); return false;">
    <p>See source</p><img src="images/ic_github_white.svg" alt="github">
  </button>
`;
...
projectFourSeeLiveSource.innerHTML = `
  <button class="see-live" type="button" onclick="window.open('https://cosmos-travelers-hub.netlify.app/'); return false;">
    <p>See live</p><img src="images/ic_link.svg" alt="download-icon">
  </button>
...
projectFiveSeeLiveSource.innerHTML = `
  ...
  <button class="see-source" type="button" onclick="window.open('https://github.com/rickleibow/Recipe-App-Capstone'); return false;">
    <p>See source</p><img src="images/ic_github_white.svg" alt="github">
  </button>
`;
...
projectSixSeeLiveSource.innerHTML = `
  ...
  <button class="see-source" type="button" onclick="window.open('https://github.com/rickleibow/budget'); return false;">
    <p>See source</p><img src="images/ic_github_white.svg" alt="github">
  </button>
`;
